...
- [ ] 用一句话写清楚真实问题：最终目标是换工作，所以你要把项目包装成招聘方能判断能力的证据，而不是一堆学习笔记。
- [ ] 画出前端、服务端、模型 / 数据、验证层之间的边界。
- [ ] 写清楚前端切入点：作品集页面本身也要体现前端能力：结构清楚、交互顺、证据可点开。
- [ ] 列出本周必须补的后端基础：项目 README 标准、架构图表达、指标展示、面试追问准备、技术取舍复盘。
- [ ] 列出本周不做什么，避免范围失控。
...
`advanced-track/lessons/week-20/day-01.md`
