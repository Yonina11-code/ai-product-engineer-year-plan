...
- [ ] 用一句话写清楚真实问题：这个项目不是练 Prompt，而是证明你能把一个 AI 文本能力做成可用、可测、可复盘的小产品。
- [ ] 画出前端、服务端、模型 / 数据、验证层之间的边界。
- [ ] 写清楚前端切入点：做一个像真实功能的页面：输入原话、选择目标语气、展示改写结果、解释改写原因、复制输出。
- [ ] 列出本周必须补的后端基础：端到端接口设计、DTO / ViewModel 边界、错误码到 UI 状态映射、最小验收接口、本地部署。
- [ ] 列出本周不做什么，避免范围失控。
...
`advanced-track/lessons/week-06/day-01.md`
