...
- [ ] 用一句话写清楚真实问题：这是偏 AI 产品工程师方向的项目，重点证明你能把用户场景、AI 能力、工程边界和安全策略结合起来。
- [ ] 画出前端、服务端、模型 / 数据、验证层之间的边界。
- [ ] 写清楚前端切入点：前端做成完整产品感：今日记录、趋势摘要、建议卡片、反馈按钮、安全提示。
- [ ] 列出本周必须补的后端基础：用户上下文组装、历史摘要、反馈数据、安全分类、上线前验收。
- [ ] 列出本周不做什么，避免范围失控。
...
`advanced-track/lessons/week-18/day-01.md`
