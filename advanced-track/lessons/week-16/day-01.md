...
- [ ] 用一句话写清楚真实问题：这一周把 RAG、Tool、Agent 和 MCP 串成一个真正能讲清楚的综合项目。
- [ ] 画出前端、服务端、模型 / 数据、验证层之间的边界。
- [ ] 写清楚前端切入点：前端重点展示完整 Trace：检索了什么、调用了什么工具、为什么拒答或继续查。
- [ ] 列出本周必须补的后端基础：多能力编排、Trace 数据结构、错误传播、权限分层、综合项目验收。
- [ ] 列出本周不做什么，避免范围失控。
...
`advanced-track/lessons/week-16/day-01.md`
